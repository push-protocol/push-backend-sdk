...
export default class NotificationHelper {
     ...
     */
    sendNotification(user: string, title: string, message: string, payloadTitle: string, payloadMsg: string, notificationType: number, cta: string | undefined, img: string | undefined, simulate: any, { offChain, returnPayload }?: {
        offChain?: boolean | undefined;
        returnPayload?: boolean | undefined;
    }): Promise<any>;
    /**
     * Get Payload Hash
